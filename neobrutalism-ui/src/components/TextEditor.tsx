...
const TextEditor = React.forwardRef<HTMLDivElement, TextEditorProps>(
  (
    ...
    return (
      <div
        ref={ref}
        className={cn('border-3 border-black bg-white shadow-brutal', className)}
        {...props}
      >
        {showToolbar && (
          <div className="flex items-center gap-1 p-2 border-b-3 border-black bg-gray-50 flex-wrap">
            ...
            <button
              ...
              title="Clear"
              className={cn(
                'px-3 py-2 border-2 border-black bg-white text-black transition-all font-medium text-sm',
        ...
        <div className="relative">
          <div
            ...
            className={cn(
              ...
              'focus:ring-4 focus:ring-black focus:ring-inset',
              disabled && 'cursor-not-allowed opacity-50 bg-gray-50',
              !value && !isFocused && 'empty:before:content-[attr(data-placeholder)] empty:before:text-gray-500'
            )}
            style={{
              minHeight,
              maxHeight,
