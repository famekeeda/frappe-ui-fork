  ...
  (
    ...
    return (
      <div ref={ref} className={cn('w-full', className)} {...props}>
        <div
          className={cn(
            'relative border-3 border-dashed border-black bg-white p-8 text-center transition-all cursor-pointer shadow-brutal',
        ...
        {value.length > 0 && (
          <div className="mt-4 space-y-2">
            {value.map((file, index) => (
              <div
                key={index}
                className="flex items-center justify-between p-3 border-3 border-black bg-white shadow-brutal-sm"
              >
                ...
                <button
                  ...
                  className="ml-2 p-1 hover:bg-gray-100 transition-colors"
                  disabled={disabled}
                >
                  <svg
