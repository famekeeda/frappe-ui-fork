...
const TabButtons = React.forwardRef<HTMLDivElement, TabButtonsProps>(
  ({ className, tabs, value, onChange, color = 'black', size = 'md', ...props }, ref) => {
    ...
    const colorClasses = {
      black: {
        active: 'bg-black text-white shadow-brutal',
        inactive: 'bg-white text-black hover:bg-gray-50',
      },
      red: {
      ...
      purple: {
        ...
        inactive: 'bg-white text-purple-500 hover:bg-purple-50',
      },
      blue: {
        active: 'bg-blue-500 text-white shadow-brutal-blue',
        inactive: 'bg-white text-blue-500 hover:bg-blue-50',
      },
      yellow: {
        active: 'bg-yellow-500 text-black shadow-brutal-yellow',
        inactive: 'bg-white text-yellow-600 hover:bg-yellow-50',
      },
    }
        ...
        {tabs.map((tab) => {
          ...
          return (
            <button
              ...
              className={cn(
                'inline-flex items-center justify-center font-bold border-3 border-black transition-all',
