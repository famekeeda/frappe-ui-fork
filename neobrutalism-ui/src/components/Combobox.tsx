  ...
  (
    ...
    return (
      <div ref={wrapperRef} className={cn('relative w-full', className)}>
        ...
        {open && (
          <div className="absolute z-50 w-full mt-2 border-3 border-black bg-white shadow-brutal-lg">
            ...
            <div className="max-h-80 overflow-auto p-1">
              {filteredOptions.length === 0 ? (
                ...
                Object.entries(groupedOptions).map(([group, groupOptions]) => (
                  <div key={group}>
                    {group !== 'default' && (
                      <div className="px-3 py-2 text-xs font-black text-gray-600 uppercase">
                        {group}
                      </div>
                    )}
