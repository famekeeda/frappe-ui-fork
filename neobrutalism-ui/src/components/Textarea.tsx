...
const textareaVariants = cva(
  'flex min-h-[80px] w-full border-3 border-black bg-white px-4 py-3 font-medium shadow-brutal transition-all placeholder:text-gray-500 focus-visible:outline-none focus-visible:ring-4 focus-visible:ring-black focus-visible:ring-offset-4 disabled:cursor-not-allowed disabled:opacity-50 resize-y',
  {
    variants: {
      variant: {
