    ...
    const renderNode = (node: TreeNode, depth = 0) => {
      ...
      return (
        <div key={node.id} className="select-none">
          <div
            className={cn(
              'flex items-center gap-2 px-2 py-1.5 hover:bg-gray-100 cursor-pointer transition-colors border-l-3',
              isSelected
          ...
          {isExpanded && hasChildren && (
            <div className={cn(showLines && 'border-l-2 border-gray-200 ml-4')}>
              {children.map((child) =>
