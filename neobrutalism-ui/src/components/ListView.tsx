    ...
    return (
      <ListViewContext.Provider value={contextValue}>
        <div
          ref={ref}
          className={cn(
            'border-3 border-black bg-white shadow-brutal overflow-auto',
            className
          )}
          {...props}
        >
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'flex items-center bg-gray-50 border-b-3 border-black font-black text-sm',
          className
        )}
        {...props}
      >
...
const ListRows = React.forwardRef<HTMLDivElement, ListRowsProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <div ref={ref} className={cn('divide-y-2 divide-gray-200', className)} {...props}>
        {children}
      </div>
    )
  }
  ...
  ({ className, children, collapsible, collapsed, onCollapsedChange, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'flex items-center gap-2 px-4 py-2 bg-gray-100 border-y-2 border-gray-300 font-bold text-sm',
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
          'flex items-center justify-between px-4 py-3 border-t-3 border-black bg-gray-50',
          className
        )}
        {...props}
      >
  ...
  ({ className, children, count = 0, onClear, ...props }, ref) => {
    ...
    return (
      <div
        ref={ref}
        className={cn(
          'flex items-center justify-between px-4 py-3 bg-blue-100 border-b-3 border-blue-500 font-medium',
          className
        )}
        {...props}
      >
        ...
        <div className="flex items-center gap-2">
          ...
          {onClear && (
            <button
              type="button"
              onClick={onClear}
              className="px-3 py-1.5 text-sm font-bold border-2 border-black bg-white hover:bg-gray-100 transition-all"
            >
              Clear
            </button>
          )}
